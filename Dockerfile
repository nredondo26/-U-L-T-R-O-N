...
HEALTHCHECK --interval=30s --timeout=5s --start-period=10s --retries=3 CMD curl -f http://localhost:3456/healthz || exit 1
ENTRYPOINT ["ultron", "--web", "--port", "3456", "--bind", "0.0.0.0"]
